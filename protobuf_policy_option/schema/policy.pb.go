...
const file_policy_proto_rawDesc = "" +
	"\n" +
	"\fpolicy.proto\x12\tpolicy.v1\x1a google/protobuf/descriptor.proto\"U\n" +
	"\fFieldMapping\x12 \n" +
	"\vplaceholder\x18\x01 \x01(\tR\vplaceholder\x12#\n" +
	"\rrequest_field\x18\x02 \x01(\tR\frequestField\"|\n" +
	"\x06Policy\x12\x1a\n" +
	"\bresource\x18\x01 \x01(\tR\bresource\x12\x16\n" +
	"\x06action\x18\x02 \x01(\tR\x06action\x12>\n" +
	"\x0efield_mappings\x18\x03 \x03(\v2\x17.policy.v1.FieldMappingR\rfieldMappings:K\n" +
	"\x06policy\x12\x1e.google.protobuf.MethodOptions\x18І\x03 \x01(\v2\x11.policy.v1.PolicyR\x06policyBAZ?github.com/o3co/grpc.authz/protobuf_policy_option/schema;policyb\x06proto3"
